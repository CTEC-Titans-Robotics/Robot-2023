...
public class ArmNew extends ProfiledPIDSubsystem {
  public static final CANSparkMax m_mainController =
      new CANSparkMax(Constants.IDs.kArmMainCANID, CANSparkMaxLowLevel.MotorType.kBrushless);
  public static final CANSparkMax m_followerController =
      new CANSparkMax(Constants.IDs.kArmFollowerCANID, CANSparkMaxLowLevel.MotorType.kBrushless);
